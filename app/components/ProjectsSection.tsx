...
export default function ProjectsSection() {
  ...
  return (
    <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-6 px-6 py-16 sm:px-10">
      <Reveal>
      ...
      {projects && projects.length === 0 && (
        <p className="text-sm text-white/60">No public repos to show yet.</p>
      )}
        ...
        <>
          ...
          >
            ...
            <button
              ...
              onClick={() => go(-1)}
              className="absolute left-0 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-black/50 text-white backdrop-blur-sm transition-all hover:scale-110 hover:bg-black/70"
            >
              ‹
            </button>
            <button
              ...
              onClick={() => go(1)}
              className="absolute right-0 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-black/50 text-white backdrop-blur-sm transition-all hover:scale-110 hover:bg-black/70"
            >
              ›
            </button>
          </div>
